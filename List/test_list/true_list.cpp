...
int main()
{
	...
	std::list<int> fir (5,200);  // five ints with a value of 200

	std::cout << "fir contains before swap:";
	for (std::list<int>::iterator it=fir.begin(); it!=fir.end(); it++)
		std::cout << ' ' << *it;
	std::cout << '\n';
	...
	for (std::list<std::string>::iterator it=tp.begin(); it != tp.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << '\n';
	...
	for (std::list<double>::iterator it=six.begin(); it!=six.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << '\n';
